...
function MovieWatchedList({ children }) {
  return <>{children}</>;
}
    ...
    <>
      <div className="summary">
        ...
        <div>
          ...
          <p>
            <span>⌛</span>
            <span>{!isNaN(avgRuntime) ? avgRuntime : "0"}</span>
          </p>
        </div>
      </div>
    </>
...
function WatchedList({ watched, onHandleDeleteWatchedMovie }) {
  return (
    <>
      <ul className="list">
        {watched.map((movie) => (
